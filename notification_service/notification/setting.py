...
KAFKA_NOTIFICATION_TOPIC = config.get("KAFKA_NOTIFICATION_TOPIC", cast=str)
KAFKA_CONSUMER_GROUP_ID_FOR_NOTIFICATION = config.get(
    "KAFKA_CONSUMER_GROUP_ID_FOR_NOTIFICATION", cast=str)
